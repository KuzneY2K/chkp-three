    ...
    <section class="row p-0 m-0 main-row">
      <div class="col-12 p-0 m-0 bg-primary bg-gradient">
        <section class="row p-0 m-0 note-container-row p-5 mt-5">
          <div class="col-3 offset-1 note-info rounded bg-primary bg-opacity-25 shadow border border-3 border-light">
            <!-- jot title -->
          ...
          <div class="col-7 rounded bg-opacity-25 text-center shadow jot-bg">
            ...
            <textarea name="jotTextArea" placeholder="Type here...." id="jotTextArea" name="content" cols="95" rows="16" class="m-0 p-0 shadow"></textarea>
        ...
        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            ...
            <div class="offcanvas-body">
                <div class="p-0 m-0">
                    ...
                    <input type="text"
                                placeholder="JOT NAME" class="form-control" name="name" id='jot-name-input'>
                        <div class="d-flex flex-row">
                            <button class="btn btn-danger" input type="submit">Create New Jot</button><input type="color" name="color" id="color" class="m-auto p-0"> <label for="color" class="m-auto p-0"><= Choose a Jot color</label>
                                </div>
                    </form>
